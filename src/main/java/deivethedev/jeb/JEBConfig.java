...
public class JEBConfig {
	...
	static {
		TOML.addCategory("IDs")
			.addEntry("startingItemID", "Default: 22000", 18000) // id that your items id start with (please change id to something else)
			.addEntry("startingBlockID", "Default: 7000", 10000); // id that your blocks id start with (please change id to something else)

		CFG = new TomlConfigHandler(JEBMain.MOD_ID, TOML);
	}
}
